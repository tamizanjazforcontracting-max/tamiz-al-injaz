...
export const LEADERSHIP = [
  ...
  {
    roleAr: 'مهندس المشاريع العام',
    roleEn: 'Lead Project & Structural Engineer',
    ...
    descEn: 'Lead resident engineer supervising all site construction, technical quality control, and SBC compliance.',
    iconName: 'HardHat'
  }
];
